export const site = {
  ...
  description: "Infrastruktur perlengkapan event untuk korporasi, pemerintah, konferensi, exhibition, gala, dan wedding di Jabodetabek.",
...
export const organizationSchema = {
  ...
  "@graph": [
    { "@type": "Organization", "@id": `${site.domain}/#organization`, name: site.name, url: site.domain, logo: `${site.domain}/brand/hr-production-logo.svg`, email: site.email, telephone: site.phoneDisplay },
